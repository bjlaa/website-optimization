...
// moved pizzasDiv outside the loop in order to improve loading perf
...
//applied method showed by reviewer + changed the multiplier in
// item[i].style.left calculus to make pizzas slide over big 27" screen
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  //declared elem  and movingPizzas outside of the loop to prevent it from being created at each iteration
